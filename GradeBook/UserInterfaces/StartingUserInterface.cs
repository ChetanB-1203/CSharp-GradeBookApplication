...
namespace GradeBook.UserInterfaces
{
    public static class StartingUserInterface
    {
        ...
        public static void CreateCommand(string command)
        {
            ...
            if(type == "standard")
            {
                gradeBook = new StandardGradeBook(type ,true);
            }else if(type == "ranked")
            {
                gradeBook = new RankedGradeBook(type ,true);
            }
            else
            {
        ...
        public static void HelpCommand()
        {
            ...
            Console.WriteLine("Create 'Name' 'Type' 'Weighted' - Creates a new gradebook " +
                "where 'Name' is the name of the gradebook, 'Type' is what type of grading it should use, " +
